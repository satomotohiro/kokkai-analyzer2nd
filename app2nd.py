...
# --- UI ---
st.title("🎤 国会議員の発言分析")
st.markdown("国会議事録をもとに議員や政党の発言からキーワードに関する主張や考え方を生成AIが要約します。")
st.markdown("生成AIの要約精度は必ずしも正確ではありません。要約の根拠となる国会での発言もぜひ併せてご確認ください")
st.markdown("選挙で「誰に・どの党に投票するか」の参考の一つになれば幸いです。")
st.markdown("### 🎯 検索条件を設定")
